...
def palabras_a_jugar ():
    ...
    palabras_elegidas = {1: ["cuarteto de nos", "la mejor banda de rock papa"], 2: ["unicornio_paranoico", "uni"], 3:["krussu", "yo"]}
...
def mostrar_tablero(juego_1, juego_2, juego_3):
    j1 = juego_1[2]
    #print(j1)
    j2 = juego_2[2]
    #print(j2)
...
Turno letra [?] - palabra de {l_palabra} letras
Definicion: {d1}""")
#tablero()
#segunda_linea(ingreso_palabra(juego_1(palabras_a_jugar()), aciertos_errores()[0], aciertos_errores()[1])[3], n1)
